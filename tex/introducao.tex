...
As expressões regulares partem da teoria da computação, mais especificamente a teoria das automatas.
Será definida as automatas, como elas são capazes de processar expressões regulares e finalemente será abordado a implementação do módulo em Haskell para a busca em texto.
